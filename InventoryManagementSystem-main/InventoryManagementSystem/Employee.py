...
class SecondPage:
    def __init__(self, manage_page):
        ...
        manage_page.title("Inventory Management System")
        ...
        with sqlite3.connect("Database/PhotoExpress.db") as db:
            cur = db.cursor()
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                Manage_window.title("Inventory Management System")
                ...
                # =================== HOME PAGE ========================================================
                # ======================================================================================
                product_page.config(background='#C8F6C4')
                ...
                admLabel = Label(product_page, text='EMPLOYEE', font=('Berlin Sans FB', 18, 'bold'), fg='#ffc329',
                                 bg='#f6f6f9')
                admLabel.place(x=1120, y=11)

                # ========== HOME BUTTON =======
                home_button = Button(product_page, text='Home', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"), bd=0,
                                     fg='#7a7a7a',
                                     cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                     command=lambda: home())
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(product_page, text='Manage', bg='#FF3661', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                       command=manage)
                ...
                # ========== PRODUCTS BUTTON =======
                product_button = Button(product_page, text='Products', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"),
                                        bd=0,
                                        fg='#7a7a7a',
                                        cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                        command=manage)
                ...
                # ========== LOG OUT =======
                logout_button = Button(product_page, text='Logout', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#7a7a7a',
                                       cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                       command=logout)
                ...
                self.button6.configure(activebackground="#FF3661")
                self.button6.configure(cursor="hand2")
                self.button6.configure(foreground="#ffffff")
                self.button6.configure(background="#FF3661")
                ...
                # Manage Item Label
                manageItem = Label(coverFrame2, text='MANAGE ITEM', font=("yu gothic ui", 13, "bold"), bg='#ffffff',
                                   fg='#FF3661')
                manageItem.place(x=80, y=0)
                ...
                idName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                     font=("Tw Cen MT", 11, 'bold'), textvariable=item_id)
                idName_entry.place(x=22, y=44, width=40, height=24)
                idName_entry.config(highlightbackground="#6b6a69", highlightcolor="#FF3661")

                # ITEM NAME AND ENTRY
                itemLabel = Label(coverFrame3, text="ITEM", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
                itemLabel.place(x=90, y=40)

                itemName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                       font=("Tw Cen MT", 12, 'bold'), textvariable=item)
                itemName_entry.place(x=10, y=70, width=225, height=34)
                ...
                typeName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                       font=("Tw Cen MT", 12, 'bold'), textvariable=type)
                ...
                discountName_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                           font=("Tw Cen MT", 12, 'bold'), textvariable=discount)
                ...
                inStock_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                      font=("Tw Cen MT", 12, 'bold'), textvariable=in_stock)
                inStock_entry.place(x=10, y=270, width=225, height=34)
                inStock_entry.config(highlightbackground="#6b6a69", highlightcolor="#FF3661")
                ...
                price_entry = Entry(coverFrame3, highlightthickness=2, relief=FLAT, bg="#ffffff", fg="#6b6a69",
                                    font=("Tw Cen MT", 12, 'bold'), textvariable=price)
                price_entry.place(x=80, y=340, width=100, height=34)
                price_entry.config(highlightbackground="#6b6a69", highlightcolor="#FF3661")
                ...
                def show_all():
                    ...
                    cur = conn.cursor()
                    cur.execute("select * from Item_Category")
                    rows = cur.fetchall()
                    if len(rows) != 0:
                ...
                def item_info(ev):
                    viewInfo = item_tree.focus()
                    item_data = item_tree.item(viewInfo)
                ...
                def add_item():
                    if item_id.get() == "":
                        messagebox.showerror("Failed", "Item Number( # ) can't be empty")
                    else:
                        conn = sqlite3.connect("Database/PhotoExpress.db")
                        cur = conn.cursor()
                        cur.execute("INSERT INTO Item_Category values(?,?,?,?,?,?)",
                                    (
                                    item_id.get(), item.get(), type.get(), discount.get(), in_stock.get(), price.get()))
                        conn.commit()
                        conn.close()
                        show_all()
                        messagebox.showinfo("Success", "Item Records Added Successfully")

                def delete_records():
                    try:
                        tree_view_content = item_tree.focus()
                        tree_view_items = item_tree.item(tree_view_content)
                        ...
                        if ask is True:
                            conn = sqlite3.connect("Database/PhotoExpress.db")
                            cur = conn.cursor()
                            cur.execute("DELETE FROM Item_Category where item_id=?", [item_id.get()])
                            conn.commit()
                            show_all()
                            clear_all()
                            conn.close()
                ...
                def update():
                    ...
                    cur = conn.cursor()
                    cur.execute(
                        "UPDATE Item_Category set item_name=?,type=?,discount=?,in_stock=?,item_price=? where "
                        "item_id=?",
                        (item.get(), type.get(), discount.get(), in_stock.get(), price.get(), item_id.get()))
                    conn.commit()
                    conn.close()
                    show_all()
                    # self.Reset()
                    messagebox.showinfo("Success", "Item Record updated Successfully")

                self.button3 = Button(coverFrame3)
                self.button3.place(relx=0.539, rely=0.849, width=86, height=25)
                self.button3.configure(relief="flat")
                self.button3.configure(overrelief="flat")
                self.button3.configure(activebackground="#FF3661")
                self.button3.configure(cursor="hand2")
                self.button3.configure(foreground="#ffffff")
                self.button3.configure(background="#FF3661")
                ...
                self.button4.configure(activebackground="#FF3661")
                self.button4.configure(cursor="hand2")
                self.button4.configure(foreground="#ffffff")
                self.button4.configure(background="#FF3661")
                self.button4.configure(font="-family {Poppins SemiBold} -size 10")
                self.button4.configure(borderwidth="0")
                self.button4.configure(text="""Add""")
                self.button4.configure(command=add_item)
                ...
                self.button5.configure(activebackground="#FF3661")
                self.button5.configure(cursor="hand2")
                self.button5.configure(foreground="#ffffff")
                self.button5.configure(background="#FF3661")
                ...
                item_tree = ttk.Treeview(coverFrame)
                item_tree.place(relx=0.0500, rely=0.228, width=896, height=410)
                item_tree.configure(
                    yscrollcommand=scrollbary.set, xscrollcommand=scrollbarx.set
                )
                item_tree.configure(selectmode="extended")

                scrollbary.configure(command=item_tree.yview)
                scrollbarx.configure(command=item_tree.xview)
                ...
                item_tree.heading("ItemID", text="#", anchor=N)
                item_tree.heading("ItemName", text="ITEM", anchor=N)
                item_tree.heading("Type", text="TYPE", anchor=N)
                item_tree.heading("Discount", text="DISCOUNT", anchor=N)
                item_tree.heading("InStock", text="IN STOCK", anchor=N)
                item_tree.heading("Price", text="PRICE ( $ )", anchor=N)

                item_tree.column("#0", stretch=NO, minwidth=0, width=0)
                item_tree.column("#1", stretch=NO, minwidth=0, width=50, anchor=N)
                item_tree.column("#2", stretch=NO, minwidth=0, width=288, anchor=N)
                item_tree.column("#3", stretch=NO, minwidth=0, width=176, anchor=N)
                item_tree.column("#4", stretch=NO, minwidth=0, width=110, anchor=N)
                item_tree.column("#5", stretch=NO, minwidth=0, width=110, anchor=N)
                item_tree.column("#6", stretch=NO, minwidth=0, width=160, anchor=N)
                item_tree.bind("<ButtonRelease-1>", item_info)
                show_all()
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                admLabel = Label(biller, text='EMPLOYEE', font=('Berlin Sans FB', 18, 'bold'), fg='#ffc329',
                                 bg='#f6f6f9')
                admLabel.place(x=1170, y=11)

                # ========== HOME BUTTON =======
                home_button = Button(biller, text='Home', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"), bd=0,
                                     fg='#7a7a7a',
                                     cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                     command=lambda: home())
                home_button.place(x=70, y=15)
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(biller, text='Manage', bg='#FF3661', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                       command=manage)
                manage_button.place(x=150, y=15)
                ...
                # ========== PRODUCTS BUTTON =======
                product_button = Button(biller, text='Products', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"), bd=0,
                                        fg='#7a7a7a',
                                        cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                        command=manage)
                product_button.place(x=250, y=15)
                ...
                # ========== LOG OUT =======
                logout_button = Button(biller, text='Logout', bg='#f6f6f9', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#7a7a7a',
                                       cursor='hand2', activebackground='#FF3661', activeforeground='#7a7a7a',
                                       command=logout)
                logout_button.place(x=350, y=15)
                ...
                self.genCashier_name = Label(self.coverFrame6, text='Employee Name', font=("yu gothic ui", 10, "bold"),
                                             bg='#ffffff', fg='#000000')
                ...
                self.item_name = Label(biller)
                self.item_name.place(x=45, y=430)
                self.item_name.configure(font="-family {Poppins Light} -size 11")
                self.item_name.configure(foreground="#000000")
                self.item_name.configure(text="Item Name")
                self.item_name.configure(background="#ffffff")
                ...
                self.cashier_name.configure(text="Employee Fullname")
                ...
                self.entry3.configure(highlightbackground="#6b6a69", highlightcolor="#FF3661")
                ...
                self.button2.configure(activebackground="#FF3661")
                self.button2.configure(cursor="hand2")
                self.button2.configure(foreground="#ffffff")
                self.button2.configure(background="#FF3661")
                ...
                self.button7.configure(activebackground="#FF3661")
                self.button7.configure(cursor="hand2")
                self.button7.configure(foreground="#ffffff")
                self.button7.configure(background="#FF3661")
                ...
                self.button8.configure(activebackground="#FF3661")
                self.button8.configure(cursor="hand2")
                self.button8.configure(foreground="#ffffff")
                self.button8.configure(background="#FF3661")
                ...
                self.button9.configure(activebackground="#FF3661")
                self.button9.configure(cursor="hand2")
                self.button9.configure(foreground="#ffffff")
                self.button9.configure(background="#FF3661")
                ...
                find_category = "SELECT type FROM Item_Category"
                ...
                self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#FF3661")
                ...
                head = "\n\n\t\t KONICA\n" \
                       "\t\t Damballelos St. Balayan\n\n\t\t THANK YOU FOR CHOOSING OUR PRODUCTS\n" \
                       "\t\t WE HOPE TO SEE YOU NEXT TIME\n\n\n" + "\tITEM\t  -----  \tQUANTITY\t  -----  \tPRICE ( $ )\n"
                self.Scrolledtext1.insert('insert', head)

                self.combo1.bind("<<ComboboxSelected>>", self.get_category)

                btn_print = Button(top, text="""Print""",
                                   command=lambda: print_area(self.Scrolledtext1.get('1.0', END)),
                                   overrelief="flat", bd=0, foreground="#ffffff", relief="flat", cursor="hand2",
                                   font="-family {Poppins SemiBold} -size 10", bg='#FF3661', activebackground="#FF3661")
            ...
            def get_category(self, Event):
                ...
                self.combo2.set('')
                self.combo3.set('')
                find_subcat = "SELECT discount FROM Item_Category WHERE type = ?"
            ...
            def get_subcat(self, Event):
                ...
                self.combo3.set('')
                find_product = "SELECT item_name FROM Item_Category WHERE type = ? and discount = ?"
            ...
            def show_qty(self, Event):
                ...
                find_qty = "SELECT in_stock FROM Item_Category WHERE item_name = ?"
            ...
            def add_to_cart(self):
                ...
                if strr.find('Total') == -1:
                    ...
                    if (product_name != ""):
                        ...
                        find_mrp = "SELECT item_price, in_stock FROM Item_Category WHERE item_name = ?"
                        ...
                        if product_qty.isdigit() == True:
                            if (stock - int(product_qty)) >= 0:
                                ...
                                item = IteemItem(product_name, mrp, int(product_qty))
                    ...
                    if (product_name != ""):
                        product_qty = self.entry4.get()
                        find_mrp = "SELECT item_price, in_stock, item_id FROM Item_Category WHERE item_name = ?"
                        cur.execute(find_mrp, [product_name])
                        results = cur.fetchall()
                        stock = results[0][1]
                        mrp = results[0][0]
                    ...
                    if (cust_name.get() == ""):
                        ...
                        if strr.find('Total') == -1:
                            ...
                            for name, qty in self.cart.dictionary.items():
                                update_qty = "UPDATE Item_Category SET in_stock = in_stock - ? WHERE item_name = ?"
