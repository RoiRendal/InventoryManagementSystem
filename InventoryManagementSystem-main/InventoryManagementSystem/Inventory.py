...
class InventoryPage:
    def __init__(self, Manage_window):
        ...
        # ========== MANAGE BUTTON =======
        manage_button = Button(product_page, text='Manage', bg='#E75373', font=("", 13, "bold"), bd=0,
        ...
        # ITEM NAME AND ENTRY
        itemLabel = Label(coverFrame3, text="BILL NUMBER", bg='#ffffff', font=("yu gothic ui", 12, "bold"))
        itemLabel.place(x=90, y=10)
        ...
        coffeName_entry.config(highlightbackground="#6b6a69", highlightcolor="#FF3661")
        ...
        item_tree.heading("BillNumber", text="BILL NUMBER", anchor=N)
        item_tree.heading("Date", text="DATE", anchor=N)
        item_tree.heading("CashierName", text="CASHIER NAME", anchor=N)
        item_tree.heading("contact", text="CONTACT", anchor=N)
        # item_tree.heading("BillDetails", text="#", anchor=N)

        item_tree.column("#0", stretch=NO, minwidth=0, width=0)
        item_tree.column("#1", stretch=NO, minwidth=0, width=230, anchor=N)
        item_tree.column("#2", stretch=NO, minwidth=0, width=150, anchor=N)
        item_tree.column("#3", stretch=NO, minwidth=0, width=352, anchor=N)
        item_tree.column("#4", stretch=NO, minwidth=0, width=110, anchor=N)
        # item_tree.column("#5", stretch=NO, minwidth=0, width=50, anchor=N)
