...
import InventoryManagementSystem.Accounts
    ...
    def __init__(self, manage_page):
        ...
        class Manage:
            def __init__(self, Manage_window):
                ...
                admLabel = Label(product_page, text='ADMIN', font=('Berlin Sans FB', 18, 'bold'), fg='#ffc329',
                                 bg='#f6f6f9')
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(product_page, text='Manage', bg='#E75373', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#E75373', activeforeground='#7a7a7a')
                ...
                def add_item():
                    if item_id.get() == "":
                        ...
                        cur.execute("INSERT INTO Item_Category values(?,?,?,?,?,?)",
                                    (
                                        item_id.get(), item.get(), type.get(), discount.get(), in_stock.get(),
                                        price.get()))
                        conn.commit()
                        conn.close()
                        show_all()
                ...
                def accounts():
                    win = Toplevel()
                    InventoryManagementSystem.Accounts.InventoryPage(win)
                    Manage_window.withdraw()
                    win.deiconify()
        ...
        class BillWindow:
            def __init__(self, top=None):
                ...
                admLabel = Label(biller, text='ADMIN', font=('Berlin Sans FB', 18, 'bold'), fg='#ffc329', bg='#f6f6f9')
                ...
                # ========== MANAGE BUTTON =======
                manage_button = Button(biller, text='Manage', bg='#E75373', font=("Tw Cen MT", 13, "bold"), bd=0,
                                       fg='#ffffff',
                                       cursor='hand2', activebackground='#E75373', activeforeground='#7a7a7a')
                manage_button.place(x=150, y=15)
                ...
                self.entry3.configure(highlightbackground="#6b6a69", highlightcolor="#E75373")
                ...
                self.button2.configure(activebackground="#E75373")
                self.button2.configure(cursor="hand2")
                self.button2.configure(foreground="#ffffff")
                self.button2.configure(background="#E75373")
                ...
                self.button7.configure(activebackground="#E75373")
                self.button7.configure(cursor="hand2")
                self.button7.configure(foreground="#ffffff")
                self.button7.configure(background="#E75373")
                ...
                self.button8.configure(activebackground="#E75373")
                self.button8.configure(cursor="hand2")
                self.button8.configure(foreground="#ffffff")
                self.button8.configure(background="#E75373")
                ...
                self.combo1.option_add("*TCombobox*Listbox.selectBackground", "#E75373")
                    ...
                    if (product_name != ""):
                        ...
                        if product_qty.isdigit() == True:
                            if (stock - int(product_qty)) >= 0:
                                ...
                                item = ItemItem(product_name, mrp, int(product_qty))
